...
function LogoFull() {
  return (
    <svg width="140" height="44" viewBox="0 0 340 130" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="68" y="78" fontFamily="Helvetica, Arial, sans-serif" fontSize="42" fontWeight="500" fill="#1A1A1A">nexus</text>
      <text x="69" y="100" fontFamily="Helvetica, Arial, sans-serif" fontSize="13" letterSpacing="2.5" fill="#5F5E5A">inventory os</text>
    </svg>
  );
}
